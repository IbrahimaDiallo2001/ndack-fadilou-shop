...
const PRODUCTS = [
  { id: 1, dept: "vetements", name: "T-shirt Étoilé Brodé", material: "Coton, broderies étoilées", price: "Prix sur demande", image: "/images/tshirt-etoile-brode.webp" },
  { id: 2, dept: "vetements", name: "T-shirt Essentiel Noir", material: "Coton stretch", price: "Prix sur demande", image: "/images/tshirt-essentiel-noir.webp" },
  { id: 3, dept: "vetements", name: "Manteau Ellipse", material: "Laine vierge", price: "Prix sur demande", image: "/images/manteau-ellipse.webp" },
  { id: 4, dept: "vetements", name: "Robe Éclat", material: "Soie lavée", price: "Prix sur demande", image: "/images/robe-eclat.webp" },
  ...
  { id: 7, dept: "accessoires", name: "Boutons Arête", material: "Laiton brossé", price: "140 €", image: "/images/boutons-arete.webp" },
  ...
  { id: 17, dept: "chaussures", name: "Derby Cuir Patiné", material: "Cuir patiné, semelle cousue", price: "Prix sur demande", image: "/images/derby-patine.webp" },
  { id: 18, dept: "chaussures", name: "Mocassin Lisière", material: "Veau velours", price: "340 €", image: "/images/mocassin-lisiere.webp" },
  { id: 19, dept: "chaussures", name: "Bottine Traverse", material: "Cuir ciré", price: "420 €", image: "/images/bottine-traverse.webp" },
    ...
    <div style={styles.page}>
      ...
      <header style={{ ...styles.header, ...(scrolled ? styles.headerScrolled : {}) }}>
        <div style={styles.headerInner}>
          <span style={styles.logo}>EL FADILOU SHOP</span>
      ...
      <section style={styles.hero} ref={heroRef} onMouseMove={handleHeroMove} className="mer-hero">
        ...
        <div style={styles.heroInner}>
          <p style={styles.heroEyebrow} className="mer-reveal is-visible">EL FADILOU SHOP — OUEST-FOIRE, DAKAR</p>
        ...
        <div style={styles.overlay} onClick={() => setSelected(null)} className="mer-overlay-in">
          <div style={styles.modal} onClick={(e) => e.stopPropagation()} className="mer-modal-in">
            ...
            <a
              ...
              className="mer-cta"
            >
              <span>Nous contacter pour cette pièce</span> <ArrowUpRight size={16} strokeWidth={1.5} className="mer-cta-arrow" />
            </a>
          </div>
        </div>
      )}
...
const css = `
  ...
  * { box-sizing: border-box; }
  ...
  @media (prefers-reduced-motion: reduce) {
    .mer-reveal, .mer-drift-a, .mer-drift-b, .mer-scroll-cue span, .mer-card, .mer-cta::before { animation: none !important; transition: none !important; }
