...
const PRODUCTS = [
  ...
  { id: 3, dept: "vetements", name: "Robe Méridienne", material: "Soie lavée", price: "640 €" },
  ...
  { id: 17, dept: "lunettes", name: "Solaire Méridien", material: "Verres teintés G-15", price: "290 €" },
    ...
    <div style={styles.page}>
      ...
      <header style={styles.header}>
        <div style={styles.headerInner}>
          <span style={styles.logo}>MÉRIDIEN</span>
      ...
      <section style={styles.hero}>
        ...
        <div style={styles.heroInner}>
          <p style={styles.heroEyebrow}>MÉRIDIEN — MAISON FONDÉE EN 1998</p>
      ...
      <section id="maison" style={styles.manifesto}>
        ...
        <p style={styles.manifestoBody}>
          Depuis 1998, la Maison Méridien réunit six départements sous une
          seule discipline : celle du détail juste. Chaque pièce — un tissu,
          un mécanisme, une essence — est choisie pour tenir sa place dans
          une silhouette plus vaste que l'objet lui-même.
        </p>
      </section>
      ...
      <footer id="contact" style={styles.footer}>
        <div style={styles.footerGrid}>
          <div>
            <p style={styles.logo}>MÉRIDIEN</p>
          ...
          <div>
            ...
            <div style={styles.footerIcons}>
              ...
              <a href="mailto:contact@meridien-maison.fr" aria-label="Email" style={styles.footerIconLink} className="mer-link">
        ...
        <div style={styles.footerBottom}>
          <span>© {new Date().getFullYear()} Maison Méridien</span>
      ...
      {selected && (
        <div style={styles.overlay} onClick={() => setSelected(null)}>
          <div style={styles.modal} onClick={(e) => e.stopPropagation()}>
            ...
            <a
              href={`mailto:contact@meridien-maison.fr?subject=${encodeURIComponent(
